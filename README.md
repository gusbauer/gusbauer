...
- **Lenguajes:** Java, SQL, HTML/XHTML  
- **Bases de datos:** Oracle SQL Developer (modelo HR)  
- **Herramientas:** Git, GitHub, Visual Studio Code, NetBeans, Oracle, VirtualBox  
- **Intereses actuales:** APIs, backend, IA aplicada y automatización
...
- Mini-juegos y ejercicios más grandes  
...
Seguir mejorando como desarrollador junior, ganar experiencia en entorno profesional (prácticas/primera oportunidad) y crecer en áreas como:

- Desarrollo backend con Java y APIs  
